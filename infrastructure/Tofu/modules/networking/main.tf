...
resource "aws_security_group" "alb" {
  name        = "sgp-${var.project_name}-allow-alb-${var.environment}"
...
resource "aws_security_group" "node" {
  name        = "sgp-${var.project_name}-eks-node-${var.environment}"
...
resource "aws_security_group" "data" {
  name        = "sgp-${var.project_name}-data-${var.environment}"
...
resource "aws_security_group" "mgmt" {
  name        = "sgp-${var.project_name}-mgmt-${var.environment}"
...
resource "aws_security_group" "endpoint" {
  ...
  name        = "sgp-${var.project_name}-vpce-${var.environment}"
